...
function addp(){
	...
	$.ajax({
        type: 'post',
        dataType: 'json',
        url: 'http://125.81.59.246:8081/ApiManagementSystem/project/teamproject',
		...
		success: function ( data ) {
			if (data.status ==200) {
                ...
                $.ajax({
        			...
        			url: 'http://125.81.59.246:8081/ApiManagementSystem/team/teamProject',
        			data: {
        				"projectId":pid,
        				"teamId":teamId,
        				"createUserId":userId,
...
        }
			...
			function remove(){
				$.ajax({
        			type: 'delete',
       				dataType: 'json',
        			url: 'http://125.81.59.246:8081/ApiManagementSystem/team/teamProject/'+projectId,
					success: function ( data ) {
						if (data.status ==200) {
    ...
    change.onclick =function(){
        if(statu == 0){
            ...
            $.ajax({
                type: 'PUT',
                dataType: 'json',
                url: 'http://125.81.59.246:8081/ApiManagementSystem/project/'+projectId,
                data: {
...
function member(){
	$.ajax({
		...
		// url:'http://125.81.59.246:8081/ApiManagementSystem/team/teamMember',
		data: {
            "teamId":1,
        },
    success:function(json){
...
function add_person(){
	...
	$.ajax({
		type:"get",
		dataType:"json",
		url:"http://125.81.59.246:8081/ApiManagementSystem/user/userName",
		data:{
			"userName":userName,
		},
		success:function(json){
