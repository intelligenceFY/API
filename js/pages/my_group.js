...
function addg(){
	...
	$.ajax({
        type: 'post',
        dataType: 'json',
        url: 'http://125.81.59.246:8081/ApiManagementSystem/team',
        data: {
            "createuserId":userId ,
            "teamName":name3,
            "description":name4,
...
function ajax(){
	...
	$.ajax({
        type: 'get',
        dataType: 'json',
        url: 'http://125.81.59.246:8081/ApiManagementSystem/team/userTeam',
        data: {
            "userId":userId,
            "page":1,
        },
...
                }
					...
					function remove(){
						$.ajax({
        					type: 'delete',
       						dataType: 'json',
        					url: 'http://125.81.59.246:8081/ApiManagementSystem/team/'+tId,
							success: function ( data ) {
								if (data.status ==200) {
